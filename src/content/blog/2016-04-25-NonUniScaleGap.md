...
date: 2016-04-25
category: tech
description: "非等比缩放导致的法线与光照异常，以及在引擎里的修正办法。"
tags: ["Unity", "渲染", "引擎"]
legacyUrl: "/hidden/2016/04/25/NonUniScaleGap/"
unlisted: true
---
...
最近在做内存优化时，发现一个奇怪之问题：
因为其实项目的mesh并不会在cpu进行显式的回读操作，因此我们并不需要mesh在系统内存中的那一份拷贝。只需要一份显存即可。
...
经过更加细致的统计，发现加上r/w选项的冗余消耗，scale的副本。
